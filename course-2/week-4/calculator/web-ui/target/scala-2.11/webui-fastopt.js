...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  var f = new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map(namedExpressions);
  return new $c_sci_MapLike$$anon$2().init___sci_MapLike__F1(namedExpressions, f)
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(name));
      expr = temp$expr;
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var array = [(((-jsx$4) - jsx$3) / (2 * jsx$2)), (((-jsx$1) + $uD($g["Math"]["sqrt"](x$1))) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return (($uI(remainingCharsCount$1.apply__O()) >= 15) ? "green" : (($uI(remainingCharsCount$1.apply__O()) >= 0) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
var $s_sci_DefaultMap$class__$$minus__sci_DefaultMap__O__sci_Map = (function($$this, key) {
  var b = new $c_scm_MapBuilder().init___sc_GenMap($m_sci_Map$EmptyMap$());
  var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, key$1) {
    return (function(kv$2) {
      var kv = $as_T2(kv$2);
      return (!$m_sr_BoxesRunTime$().equals__O__O__Z(kv.$$und1$f, key$1))
    })
  })($$this, key));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lcalculator_Signal__Lcalculator_Signal($as_Lcalculator_Signal(v1))
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.init___sci_Map = (function(namedExpressions$1) {
  this.namedExpressions$1$f = namedExpressions$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(signal) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, signal$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(signal$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, signal));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
var $d_sc_Iterator$$anon$13 = new $ClassTypeData({
...
var $d_sci_MapLike$$anon$2 = new $ClassTypeData({
